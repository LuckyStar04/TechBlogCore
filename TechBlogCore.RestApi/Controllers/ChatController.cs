...
namespace TechBlogCore.RestApi.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        public ChatController(IConfiguration configuration, HttpClient httpClient, IChatRepo chatRepo, UserManager<Blog_User> userManager)
        {
        ...
        [HttpGet]
        public async Task<IEnumerable<ChatDto>> GetChatList()
        {
